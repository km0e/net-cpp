...
TEST(HttpProto, parse_accept) {
  ...
  auto result1 = xsl::net::http::parse_accept(accept0);
  ...
  auto result2 = xsl::net::http::parse_accept(accept1);
  ...
  auto result3 = xsl::net::http::parse_accept(accept2);
  ...
  std::string_view accept3
      = "text/*;q=0.3, text/plain;q=0.7, text/plain;format=flowed,text/plain;format=fixed;q=0.4, "
        "*/*;q=0.5";
  auto result4 = xsl::net::http::parse_accept(accept3);
...
TEST(HttpProto, parse_accept_encoding) {
  ...
  auto result1 = xsl::net::http::parse_accept_encoding(accept_encoding0);
  ...
  auto result2 = xsl::net::http::parse_accept_encoding(accept_encoding1);
  EXPECT_EQ(result2.size(), 0);

  std::string_view accept_encoding2 = "compress;q=0.5, gzip;q=1.0";
  auto result3 = xsl::net::http::parse_accept_encoding(accept_encoding2);
  ...
  auto result4 = xsl::net::http::parse_accept_encoding(accept_encoding3);
