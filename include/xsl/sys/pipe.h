...
// std::pair<sys::io::Device<feature::In<byte>>, sys::io::Device<feature::Out<byte>>> pipe();
// std::pair<sys::io::AsyncDevice<feature::In<byte>>,
//           sys::io::AsyncDevice<feature::Out<byte>>>
// async_pipe(std::shared_ptr<sync::Poller>& poller);

// template <class Executor = coro::ExecutorBase>
// Task<std::optional<std::errc>, Executor> splice_single(
//     io::AsyncDevice<feature::In<byte>> from, io::AsyncDevice<feature::Out<byte>> to) {
//   while (true) {
...
// template <class Executor = coro::ExecutorBase>
// Lazy<void, Executor> splice(io::AsyncDevice<feature::In<byte>> from,
//                                   io::AsyncDevice<feature::Out<byte>> to,
//                                   io::AsyncDevice<feature::In<byte>> pipe_in,
//                                   io::AsyncDevice<feature::Out<byte>> pipe_out) {
